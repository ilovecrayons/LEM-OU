...
void skills() {
  ...
  easy.wait_drive();
  easy.set_drive_pid(-12, 120);
  easy.wait_drive();
  easy.set_drive_pid(12, 120);
  easy.wait_drive();
  easy.set_turn_pid(225, 120);
  easy.wait_drive();
  easy.set_drive_pid(-24, 120);
  easy.wait_drive();
  easy.set_turn_pid(180, 100);
  easy.wait_drive();
  easy.set_drive_pid(-84, 120);
  easy.wait_drive();
  ...
  easy.set_turn_pid(0, 120);
  easy.wait_drive();
  easy.set_drive_pid(-15.5, 120);
  easy.wait_drive();
  easy.set_turn_pid(-90, 120);
  easy.wait_drive();
  easy.set_drive_pid(10.5, 120);
  easy.wait_drive();
  ...
  easy.wait_drive();
  easy.set_swing_pid(ez::RIGHT_SWING, 0, 120);
  easy.wait_drive();
  easy.set_drive_pid(15, 120);
  easy.wait_drive();
  easy.set_drive_pid(-15, 120);
  front_wings.set_value(false);
  easy.wait_drive();
  easy.set_turn_pid(110, 120);
  easy.wait_drive();
  easy.set_drive_pid(-45, 120);
  easy.wait_drive();
  easy.set_turn_pid(225, 120);
  easy.wait_drive();
  back_wings.set_value(true);
  ...
  back_wings.set_value(false);
  easy.wait_drive();
  easy.set_swing_pid(ez::RIGHT_SWING, 270, 120);
  easy.wait_drive();
  easy.set_drive_pid(6, 120);
  easy.wait_drive();
  easy.set_mode(ez::DISABLE);
